...
def gen_nvim_colorscheme(p: dict, name: str) -> str:
    ...
    ln = [
        ...
        hl('CursorLine',      bg='bg_inactive'),
        hl('CursorColumn',    bg='bg_inactive'),
        ...
        '',
        '-- ── Status / Tab ──────────────────────────────────────────────────────────',
        hl('StatusLine',      fg='fg',          bg='bg_inactive'),
        hl('StatusLineNC',    fg='grey',        bg='bg_dim'),
        hl('TabLine',         fg='grey',        bg='bg_inactive'),
        hl('TabLineFill',     bg='bg'),
        hl('TabLineSel',      fg='bg',          bg='pink',        bold=True),
        '',
        '-- ── Selection / Search ─────────────────────────────────────────────────────',
        hl('Visual',          bg='bg_inactive'),
        hl('VisualNOS',       bg='bg_inactive'),
